...
public class Punto_17_Electrodomestico {
    ...
    public Punto_17_Electrodomestico(){
        this(PRECIO_BASE_DEF, PESO_DEF, CONSUMO_ENERGETICO_DEF, COLOR_DEF);
    }

    public Punto_17_Electrodomestico(double precioBase, double peso){
        this(precioBase, peso, CONSUMO_ENERGETICO_DEF, COLOR_DEF);
    }

    public Punto_17_Electrodomestico(double precioBase, double peso, char consumoEnergetico, String color){
